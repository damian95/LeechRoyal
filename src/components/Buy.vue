<template>
  <v-data-table :headers="headers" :items="displayList" class="elevation-1">
    ...
    <template v-slot:item.action="{ item }">
      <v-btn color="secondary" dark class="mb-2">BUY</v-btn>
    </template>
  </v-data-table>
</template>
...
export default {
  ...
  data: () => ({
    headers: [
      ...
      { text: "Character Class", value: "characterClass" },
    ...
    leeches: [
      ...
      {
        text: "Froscola & Jester Scarlion(67-75)",
        value: "Froscola & Jester Scarlion"
      },
